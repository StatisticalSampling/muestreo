#' @title Función cong.media
#' @description La función cong.media es utilizada para estudiar el parámetro media de una variable cuando se realiza un muestreo por conglomerados
#' (unietápico o bietápico). También es válida para proporciones utilizando variables dicotómicas.
...
#' @param v: vector que contiene los tamaños de las muestras extraídas de cada conglomerado. (v = 0, representará un muestreo por conglomerados
#'               unietápico).
...
#'
#'  -Intervalos de confianza: intervalos de confianza al nivel 1-alfa para el parámetro media poblacional, bajo los supuestos
...
#' @export cong.media
#' @examples
#' cong.media(x<-c(rnorm(1000,50,3),rnorm(2000,50,3),rnorm(500,50,3)),
